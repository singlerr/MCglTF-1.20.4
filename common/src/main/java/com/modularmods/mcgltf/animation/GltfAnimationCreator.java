...
public final class GltfAnimationCreator {
	...
	public static List<InterpolatedChannel> createGltfAnimation(AnimationModel animationModel) {
		...
		for(Channel channel : channels) {
			...
			{
				Constants.LOG.warn("Input data is not an AccessorFloatData, but "
						+ inputData.getClass());
				continue;
			}
			...
			{
				Constants.LOG.warn("Output data is not an AccessorFloatData, but "
						+ outputData.getClass());
				continue;
			}
			...
			case "translation":
				...
				case CUBICSPLINE:
					...
					break;
				default:
					Constants.LOG.warn("Interpolation type not supported: " + interpolation);
					break;
				}
				break;
			case "rotation":
			...
			case "weights":
				...
				break;
			default:
				Constants.LOG.warn("Animation channel target path must be "
