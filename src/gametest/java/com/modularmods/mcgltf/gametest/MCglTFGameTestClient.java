...
import com.modularmods.mcgltf.GltfModelHandle;
...
public final class MCglTFGameTestClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		simpleHandle = MCglTF.getInstance().registerModel(
	...
	private static void registerModel(String name, Identifier location) {
		MCglTF.getInstance().addGltfModelReceiver(new IGltfModelReceiver() {
	...
	public static RenderedGltfModel simpleModel() {
		return simpleHandle == null || !simpleHandle.isReady() ? null : simpleHandle.get();
	}
